...
#elif defined(FIRMWARE_4_46) || defined(FIRMWARE_4_50)
...
#if defined(FIRMWARE_3_41) || defined(FIRMWARE_3_55) || defined(FIRMWARE_4_30) || defined(FIRMWARE_4_46) || defined(FIRMWARE_4_50)
